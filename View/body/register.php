	...
	<div class="row">
	    <div class="col-xs-12 col-sm-8 col-md-6 col-sm-offset-2 col-md-offset-3">
			<form role="form" method="post" action="" autocomplete="off">
				...
				<div class="form-group">
					<input type="text" name="studentid" id="studentid" class="form-control input-lg" placeholder="Student id" value="<?php if(isset($error)){ echo htmlspecialchars($_POST['studentid'], ENT_QUOTES); } ?>" tabindex="2">
				</div>
				<div class="form-group">
